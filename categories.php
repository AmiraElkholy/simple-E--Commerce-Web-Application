        ...
        <section id="main-content" class="clearfix">
            <div id="categories">
                ...
                <?php
                    ...
                    $cat=new category();
                    $category=$cat->selectall();
                    ?>
                    </br><a href=#>add new category</a></br></br>
                    <table border="1">
                        <tr>
                            <th>Category Name</th>
                        ...
                        <?php
                                ...
                                if($categories->idsupercategory){
                                    $parent=$cat->selectsupcatbyid($categories->idsupercategory);
                                    echo "<td>".$parent[0]->name."</td>";
                                }
                                else{
                                    echo "<td>None</td>";
                                }
                                echo "<td><a href=#>Update</a></td>";
                                echo "<td><a href=delete-category.php?id=".$categories->idcategory.">delete</a></td>";
                                //echo "<td><a href=delete.php?email=".$row['email'].">Delete</a>  -  <a href=update.php?email=".$row['email'].">update</a></td>";
                                echo "</tr>";
                            }
                            ?>
